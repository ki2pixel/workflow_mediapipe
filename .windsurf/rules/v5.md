...
- **`edit` / `multi_edit`**: Primary means for code changes.  
  ...
  - **Comment Policy**: You are free to add comments to explain "WHY" (intent) or remove obsolete comments/commented-out code (dead code) within any edit. This is not considered a violation of the "coherent unit" rule.
