# Workflow MediaPipe v4.x — Cline Rules

> Toute déviation doit être consignée dans `decisionLog.md`. Références principales : `WorkflowState`, `WorkflowCommandsConfig`, `docs/workflow/*`, `.clinerules/codingstandards.md`.
