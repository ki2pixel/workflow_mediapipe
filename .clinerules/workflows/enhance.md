...
3. **Appel des Skills** : Identifie les fichiers de Skill pertinents avec `fast_read_file(".cline/skills/[SKILL_NAME]/SKILL.md")` et lis-les UNIQUEMENT si nécessaire.
