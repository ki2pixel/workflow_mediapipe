...
4. Utiliser `/home/kidpixel/workflow_mediapipe/.cline/skills/step5-gpu-ops/resources/engine_diagnostics.md` pour choisir le moteur, vérifier les providers ONNX, activer le profiling ou valider la densité JSON.
