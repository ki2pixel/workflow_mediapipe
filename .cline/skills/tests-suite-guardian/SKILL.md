...
- Ressource annexe : `/home/kidpixel/workflow_mediapipe/.cline/skills/tests-suite-guardian/resources/test_execution_matrix.md` (qui résume commandes, environnements, prérequis, checklist pré-run).
