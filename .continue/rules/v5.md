...
- **Updating**: Utilisez `fast_edit_block(path="/path/to/file", old_text="...", new_text="...")` pour synchroniser l'état du projet en fin de tâche.
...
- **Listing**: Utilisez `fast_list_directory(path="/home/kidpixel/workflow_mediapipe/memory-bank")` pour lister les fichiers disponibles.
- **Project Listing**: Utilisez `fast_get_directory_tree(path="/home/kidpixel/workflow_mediapipe/memory-bank")` pour diagnostiquer la connectivité en cas d'échec d'accès.
