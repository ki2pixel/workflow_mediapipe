...
> Cette archive regroupe les décisions antérieures au **5 mars 2026**. Les entrées conservent leur format original pour préserver la traçabilité complète (timestamps, contexte, impacts).
