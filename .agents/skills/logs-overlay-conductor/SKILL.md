...
- Ressource : `/home/kidpixel/workflow_mediapipe/.agents/skills/logs-overlay-conductor/resources/overlay_focus_playbook.md` (scénarios auto-open, focus trap, commandes npm/diagnostics).
