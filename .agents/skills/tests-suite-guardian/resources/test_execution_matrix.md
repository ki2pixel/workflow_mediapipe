...
| STEP5 dédiée | `bash scripts/run_step5_tests.sh` | `tracking_env_slim` | `mediapipe`, `opencv`, variables STEP5 alignées | Logs GPU/CPU affichés, erreurs converties en skips si libs absentes |
...
- [ ] Variables `TRANSNET_ENV_PYTHON`, `TRACKING_ENV_SLIM_PYTHON` pointent vers les bons interpréteurs.
